...
Some of my domains run off of [Cloudflare](https://www.cloudflare.com/) which needs to overwrite your DNS.
And, hey presto, they have an [API](https://www.cloudflare.com/docs/client-api.html). So here it is:
