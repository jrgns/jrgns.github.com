...
date: 2013-04-29
description: "Symfony 2 comes with a great [security component](https://symfony."
---

Symfony 2 comes with a great [security component](https://symfony.com/doc/current/book/security.html) that provides both [Authentication](https://symfony.com/doc/current/components/security/authentication.html)
(identifying the user) and [Authorization](https://symfony.com/doc/current/components/security/authorization.html) (determining the permissions for the user)
...
in [ACL functionality](https://symfony.com/doc/current/cookbook/security/acl.html), this can become hairy quite quickly, as you need to manage
Access Control Entries (ACE) in your controller code.

Although Symfony provides an [ACL Provider](https://api.symfony.com/2.0/Symfony/Component/Security/Acl/Dbal/AclProvider.html) with which the coder can create and
...
The key component in how Symfony manages authentication is the [AccessDecisionManager](https://api.symfony.com/2.2/Symfony/Component/Security/Core/Authorization/AccessDecisionManager.html).
