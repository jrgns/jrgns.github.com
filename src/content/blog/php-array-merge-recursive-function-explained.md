...
date: 2013-01-08
description: "Reading the PHP docs, it's not immediately clear how the [`array_merge_recursive`](https://php."
---

Reading the PHP docs, it's not immediately clear how the [`array_merge_recursive`](https://php.net/manual/en/function.array-merge-recursive.php) function behaves.
I've setup a couple of test cases and compared them with the plain [`array_merge`](https://php.net/manual/en/function.array-merge.php) function to explain it further:
