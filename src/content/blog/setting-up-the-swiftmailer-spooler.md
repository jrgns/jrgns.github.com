...
date: 2012-12-20
description: "The [Swiftmailer](https://swiftmailer."
---

The [Swiftmailer](https://swiftmailer.org/) library comes with a nifty feature where mails can be spooled to disk
...
The following comes (with some changes) from a post in the [Swiftmailer Google Group](https://groups.google.com/forum/?fromgroups=#!searchin/swiftmailer/spool/swiftmailer/xQPP5qtNnMA/k3QXcRebG-wJ):
