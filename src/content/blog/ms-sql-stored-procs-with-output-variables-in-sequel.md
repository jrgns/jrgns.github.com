...
date: 2014-01-03
description: "We had the opportunity to muck around with a couple of technologies at [Tutuka](https://www."
---

We had the opportunity to muck around with a couple of technologies at [Tutuka](https://www.tutuka.com) the last few weeks. I managed to do
some work with Ruby, specifically [Sinatra](https://www.sinatrarb.com/) and [Sequel](https://sequel.jeremyevans.net/). We use MS-SQL extensively and eventually we ran into an issue where
we couldn't get the values of output variables from stored procedures. After extensive googling we found out that it's
not supported. There were a couple of clues on how it might be done (particularly this [TinyTDS Issue](https://github.com/rails-sqlserver/tiny_tds/issues/24)), so after chatting
...
You can get a good idea on how to use it from the [documentation](https://github.com/jeremyevans/sequel/blob/master/doc/mssql_stored_procedures.rdoc), but here's a summary.
