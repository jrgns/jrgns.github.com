...
date: 2013-10-10
description: "I presented this at [Tech4Africa 2013](https://www."
---

I presented this at [Tech4Africa 2013](https://www.tech4africa.com). The slides can be found [here](https://jrgns.net/talks/phpslums).
...
There's no ideology or design philosophy, except that it should be a [simple tool to solve problems](https://toys.lerdorf.com/archives/38-The-no-framework-PHP-MVC-framework.html).

> "I've never thought of PHP as more than a simple tool to solve problems"
>
>   [Rasmus Lerdorf 2010](https://twitter.com/rasmus/status/1938080214814720)
...
PHP accounts for only 18% of applications covered by the <abbr class="Common Vulnerabilities and Exposures">[CVE](https://www.coelho.net/php_cve.html)</abbr>, but accounts for almost 29% of the  vulnerabilities
...
>
>   [@iamdevloper](https://twitter.com/iamdevloper/status/380285502580338688)
...
the unofficial (like [PHP-FIG](https://www.php-fig.org/)) communities.

If you look at the debate on what to use for indentation, [tabs](https://philsturgeon.co.uk/blog/2013/04/psr2-the-tough-decision) vs [spaces](https://github.com/php-fig/fig-standards/pull/35), the community is in total disarray.
...
Object Oriented, or just Object Capable? - [Michael Kimsal](https://michaelkimsal.com/blog/php-is-not-object-oriented/)
...
* [PSR-0](https://github.com/php-fig/fig-standards/blob/master/accepted/PSR-0.md) has enabled the creation of packaging software such as composer / packagist
* [PSR-1](https://github.com/php-fig/fig-standards/blob/master/accepted/PSR-1-basic-coding-standard.md) and [PSR-2](https://github.com/php-fig/fig-standards/blob/master/accepted/PSR-2-coding-style-guide.md) generated a lot of conflict, but at least all of the participating frameworks partially agreed on coding standards
* [PSR-3](https://github.com/php-fig/fig-standards/blob/master/accepted/PSR-3-logger-interface.md) and [PSR-4](https://github.com/php-fig/fig-standards/blob/master/proposed/psr-4-autoloader/psr-4-autoloader.md) aren't momentous decisions, but they at least pave the way forward for increased collaboration

Packagist / Composer
--------------------

[Composer](https://getcomposer.org/) is a tool to manage dependencies for a project, and manages and installs dependencies on a per project
basis. Very much on par with node's npm and ruby's bundler. [Packagist](https://packagist.org/) is a repository for composer packages and
...
>
>   [Jrgns](https://twitter.com/jrgns/status/365357629469499392)
...
languages keeps your brain sharp and young. Coding in [multiple languages](https://www.sciencemag.org/content/330/6002/332.summary) makes you a better coder.
...
>
>   [ohpalmer](https://twitter.com/ohpalmer/status/380290678502461440)
