...
date: 2011-09-13
description: "I hate repetitive work."
---
...
You can get the code on [GitHub](https://github.com/jrgns/php-virtualhost). A **Warning**: The code is **not** production ready. Use it at your own risk. Here's what it does:

An `.htaccess` file [redirects all requests](?q=content/redirect_request_to_index) to the `index.php` file, which sits in `/var/www`. We get the host from the `$_SERVER` variable, and check if a folder for that host exists.
