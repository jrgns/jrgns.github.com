...
date: 2010-03-18
description: "I've been working on [backend](https://backend-php."
---

I've been working on [backend](https://backend-php.net), a PHP framework the last couple of months, and it's really starting to take shape. I've learned a lot about what one can do by coding smarter and the advantages open source code gives on.

After getting somewhat disheartened a few weeks back, I decided to take a look at how [CodeIgnitir](https://codeigniter.com/) does things, and wow, it blew my mind. After spending some time with their code base, I had so many ideas I wanted to implement in backend and my thoughts around it was instantly rejuvinated. Problems that stopped me from progressing had new solutions, and the momentum I gathered from that helped to solve some problems that didn't have any solutions directly at hand.
...
I want to start using backend on my personal site (this one) and on another site I've got in the works, called [zacoders.net](https://zacoders.net). More on that later.
