...
date: 2013-09-17
description: "Usually when you're working with data you expect some kind of default ordering."
---
...
[custom repository classes](https://symfony.com/doc/current/book/doctrine.html#custom-repository-classes) to tweak queries to your liking:
...
The [findBy](https://www.doctrine-project.org/api/orm/2.3/class-Doctrine.ORM.EntityRepository.html#_findBy) method of the EntityRepository class is the method used by most
